...
```
```{r, echo=F, warning=FALSE, fig.align='left', fig.width=5, fig.height=3, fig.cap="2018 Ozone values by month"}
Ozone.month.2018
```
```{r, echo=F, warning=FALSE, fig.align='left', fig.width=5, fig.height=3, fig.cap="2019 Ozone values by month"}
Ozone.month.2019
```
